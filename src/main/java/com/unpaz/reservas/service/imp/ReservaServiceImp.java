...
//validar si no esta ocupada la hora y dia
    ...
    public ReservaDtoResponse guardar(ReservaDtoReq obj) {
        ...
        horaNew = (horaRepository.findById(obj.getIdHora()).orElseThrow(() ->
                new NotFoundException("No se encontro Hora con el id: " + obj.getIdHora() )));
        horaNew.setDisponible(true);
        reservaNueva.setHora(horaNew);

        reservaNueva.setCanchaPrecio(canchaPrecioRepository.findById(obj.getIdCanchaPrecio()).orElseThrow(() ->
                new NotFoundException("No se encontro Id CAnchaPrecio con el id: " + obj.getIdCanchaPrecio() )));
    ...
    public Reserva getbyId(Long id) {
        return reservaRepository.findById(id).orElseThrow(() ->
                new NotFoundException("No se encontro Reserva con el id: " + "variable"));
    }
